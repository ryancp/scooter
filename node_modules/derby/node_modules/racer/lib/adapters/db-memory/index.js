  ...
  setupRoutes: function(store) {
    ...
    MUTATORS.forEach(function(method) {
      return store.route(method, '*', -1000, function() {
        var args, docPath, done, match, next, path, topDocPath, ver, _i;
        ...
        topDocPath = docPath.split('.').slice(0, 2).join('.');
        return _this.get(topDocPath, function(err, topDoc) {
